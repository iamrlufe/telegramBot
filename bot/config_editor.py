...
Адрес есть не всегда: ошибка 4060 («Cannot open database») пишется без
[CLIENT] — в такой строке стоит «адрес не записан».
...
вовсе не стартовал. Копии из msdb — что сам SQL считает сделанным: база,
