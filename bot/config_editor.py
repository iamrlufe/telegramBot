...
пустой 🔐 Входы почти всегда означает другое: выключен аудит отказов.
Windows пишет событие 4625, только если включена политика «Аудит входа
в систему» на отказ. Проверить и включить на сервере:
