...
в кодировке консоли, а WinSCP при перенаправлении — в UTF-8. В алерте
бот разбирает их построчно, читаемо будет и то, и другое. Чтобы
читался и сам файл на сервере, добавьте в начало скрипта
chcp 65001 > nul
