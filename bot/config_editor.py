...
📊 Дашборд — вся инфраструктура одним HTML-файлом: кольцо свободного
   ...
   • Windows и SQL — журналы за сутки: счётчики по категориям
     ...
     живьём при открытии ничего не читается. У SQL отдельно
     показаны запуски джоб Agent: сколько раз отработала каждая,
     как долго шла и падала ли. Дольше SQL_JOB_LONG_HOURS (12 ч) —
     помечается: успех, но ночное окно съедено.
