...
и раз оно дошло, SPF/DMARC его не отбили. Отбитые на входе не будят
никогда — это признак работающей защиты, а не проблемы.
...
списки. Второго чтения лога для этого не делается.
