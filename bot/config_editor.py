...
MAIL_SUMMARY_ROWS строк (по умолчанию 15, потолок 20) — полный
список без среза здесь, в 📤 Отправители и 🔑 Входы. Служебные
входы самого сервера (без адреса в логе) из обзора дашборда убраны,
чтобы не вытесняли живых пользователей.
