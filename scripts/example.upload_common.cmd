...
rem СРАВНЕНИЕ СТРОКАМИ, не числами. IF ... EQU в cmd считает 32-битными
rem знаковыми и НАСЫЩАЕТСЯ: всё, что больше 2 147 483 647, становится
rem 2 147 483 647. То есть любые два файла больше 2 ГиБ для него равны:
rem
rem     if 3000000000 EQU 4000000000 (echo РАВНЫ) else (echo разные)
rem
rem Ровно на этом файл в 2.59 ГБ был объявлен равным домашним 42.22 ГБ
rem и «пропускался» каждый рейс, а ветка «докачать» не наступала никогда.
rem
